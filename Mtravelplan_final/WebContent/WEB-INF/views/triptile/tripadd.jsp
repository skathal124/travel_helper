...
<form name="frmForm" id="_frmForm" action="tripwrite.do" method="post"
	enctype="multipart/form-data">

	<div id="np_main">

		<font style="font-size: 13px; font-weight: bold; color: #474747">여행
			이름</font><br /> <input type="text" name="tname"><br />
		<br /> <font
			style="font-size: 13px; font-weight: bold; color: #474747">시작
			날짜</font> <br /> 
			<input type="text" name="sdate" class="testDatepicker"
			placeholder="&nbsp;시작 날짜를 선택해주세요" readonly="readonly"><br />
		<br /> <font
			style="font-size: 13px; font-weight: bold; color: #474747">마지막
			날짜</font> <br /> <input type="text" name="edate" class="testDatepicker"
			placeholder="&nbsp;마지막 날짜를 선택해주세요" readonly="readonly"><br />
		<br /> <font
		...
		<div align="center">
			<input id="_btnOk" type="submit" value="그룹 추가">
		</div>
